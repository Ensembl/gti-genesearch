...
public class ProteinFeature extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProteinFeature\",\"namespace\":\"org.ensembl.genesearch.avro\",\"fields\":[{\"name\":\"start\",\"type\":\"int\"},{\"name\":\"end\",\"type\":\"int\"},{\"name\":\"dbname\",\"type\":\"string\"},{\"name\":\"interpro_ac\",\"type\":[\"string\",\"null\"]},{\"name\":\"description\",\"type\":[\"string\",\"null\"]},{\"name\":\"name\",\"type\":\"string\"}]}");
   ...
   */
  public ProteinFeature(java.lang.Integer start, java.lang.Integer end, java.lang.CharSequence dbname, java.lang.CharSequence interpro_ac, java.lang.CharSequence description, java.lang.CharSequence name) {
    this.start = start;
    this.end = end;
    this.dbname = dbname;
  ...
  public static org.ensembl.genesearch.avro.ProteinFeature.Builder newBuilder() {
    return new org.ensembl.genesearch.avro.ProteinFeature.Builder();
  }
  
  /** Creates a new ProteinFeature RecordBuilder by copying an existing Builder */
  public static org.ensembl.genesearch.avro.ProteinFeature.Builder newBuilder(org.ensembl.genesearch.avro.ProteinFeature.Builder other) {
    return new org.ensembl.genesearch.avro.ProteinFeature.Builder(other);
  }
  
  /** Creates a new ProteinFeature RecordBuilder by copying an existing ProteinFeature instance */
  public static org.ensembl.genesearch.avro.ProteinFeature.Builder newBuilder(org.ensembl.genesearch.avro.ProteinFeature other) {
    return new org.ensembl.genesearch.avro.ProteinFeature.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProteinFeature>
    ...
    private Builder() {
      super(org.ensembl.genesearch.avro.ProteinFeature.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ensembl.genesearch.avro.ProteinFeature.Builder other) {
      super(other);
    ...
    private Builder(org.ensembl.genesearch.avro.ProteinFeature other) {
            super(org.ensembl.genesearch.avro.ProteinFeature.SCHEMA$);
      if (isValidValue(fields()[0], other.start)) {
        this.start = data().deepCopy(fields()[0].schema(), other.start);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'start' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setStart(int value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearStart() {
    ...
    /** Sets the value of the 'end' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setEnd(int value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearEnd() {
    ...
    /** Sets the value of the 'dbname' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setDbname(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearDbname() {
      dbname = null;
    ...
    /** Sets the value of the 'interpro_ac' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setInterproAc(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearInterproAc() {
      interpro_ac = null;
    ...
    /** Sets the value of the 'description' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setDescription(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'name' field */
    public org.ensembl.genesearch.avro.ProteinFeature.Builder setName(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.ProteinFeature.Builder clearName() {
      name = null;
