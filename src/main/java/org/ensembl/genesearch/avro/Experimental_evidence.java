...
public class Experimental_evidence extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Experimental_evidence\",\"namespace\":\"org.ensembl.genesearch.avro\",\"fields\":[{\"name\":\"primary_id\",\"type\":\"string\"},{\"name\":\"dbname\",\"type\":\"string\"},{\"name\":\"display_id\",\"type\":\"string\"},{\"name\":\"source\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Source\",\"fields\":[{\"name\":\"primary_id\",\"type\":\"string\"},{\"name\":\"dbname\",\"type\":\"string\"},{\"name\":\"display_id\",\"type\":\"string\"}]}}},{\"name\":\"rank\",\"type\":\"int\"}]}");
   ...
   */
  public Experimental_evidence() {}

  /**
   * All-args constructor.
   */
  public Experimental_evidence(java.lang.CharSequence primary_id, java.lang.CharSequence dbname, java.lang.CharSequence display_id, java.util.List<org.ensembl.genesearch.avro.Source> source, java.lang.Integer rank) {
  ...
  /** Creates a new Experimental_evidence RecordBuilder */
  public static org.ensembl.genesearch.avro.Experimental_evidence.Builder newBuilder() {
    return new org.ensembl.genesearch.avro.Experimental_evidence.Builder();
  }
  
  /** Creates a new Experimental_evidence RecordBuilder by copying an existing Builder */
  public static org.ensembl.genesearch.avro.Experimental_evidence.Builder newBuilder(org.ensembl.genesearch.avro.Experimental_evidence.Builder other) {
    return new org.ensembl.genesearch.avro.Experimental_evidence.Builder(other);
  }
  
  /** Creates a new Experimental_evidence RecordBuilder by copying an existing Experimental_evidence instance */
  public static org.ensembl.genesearch.avro.Experimental_evidence.Builder newBuilder(org.ensembl.genesearch.avro.Experimental_evidence other) {
    return new org.ensembl.genesearch.avro.Experimental_evidence.Builder(other);
  }
  
  /**
   * RecordBuilder for Experimental_evidence instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Experimental_evidence>
    implements org.apache.avro.data.RecordBuilder<Experimental_evidence> {
    ...
    private Builder() {
      super(org.ensembl.genesearch.avro.Experimental_evidence.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(org.ensembl.genesearch.avro.Experimental_evidence.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing Experimental_evidence instance */
    private Builder(org.ensembl.genesearch.avro.Experimental_evidence other) {
            super(org.ensembl.genesearch.avro.Experimental_evidence.SCHEMA$);
      if (isValidValue(fields()[0], other.primary_id)) {
        this.primary_id = data().deepCopy(fields()[0].schema(), other.primary_id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'primary_id' field */
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder setPrimaryId(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder clearPrimaryId() {
      primary_id = null;
    ...
    /** Sets the value of the 'dbname' field */
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder setDbname(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder clearDbname() {
      dbname = null;
    ...
    /** Sets the value of the 'display_id' field */
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder setDisplayId(java.lang.CharSequence value) {
    ...
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder clearDisplayId() {
      display_id = null;
    ...
    /** Sets the value of the 'source' field */
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder setSource(java.util.List<org.ensembl.genesearch.avro.Source> value) {
    ...
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder clearSource() {
      source = null;
    ...
    /** Sets the value of the 'rank' field */
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder setRank(int value) {
    ...
    public org.ensembl.genesearch.avro.Experimental_evidence.Builder clearRank() {
      fieldSetFlags()[4] = false;
      return this;
    }

    @Override
    public Experimental_evidence build() {
      try {
        Experimental_evidence record = new Experimental_evidence();
