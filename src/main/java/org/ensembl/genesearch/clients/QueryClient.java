...
public class QueryClient {
	...
	public static class Params extends ClientParams {
		...
		private List<String> resultFields = Collections.EMPTY_LIST;

		@SuppressWarnings("unchecked")
		@Parameter(names = "-facets", description = "Fields to facet by")
		private List<String> facets = Collections.EMPTY_LIST;

		@SuppressWarnings("unchecked")
		@Parameter(names = "-sort", description = "Fields to sort by")
		private List<String> sorts = Collections.EMPTY_LIST;

		@Parameter(names = "-sort_dir", description = "Direction to sort by")
		private String sortDir = QuerySort.SortDirection.ASC.name();
	...
	public static void main(String[] args) throws InterruptedException,
		...
		List<QuerySort> sorts = params.sorts
				.stream()
				.map(sort -> new QuerySort(sort, QuerySort.SortDirection
						.valueOf(params.sortDir.toUpperCase()))).collect(Collectors.toList());

		QueryResult res = search.query(queries, params.resultFields,
				params.facets, params.limit, sorts);
