 ...
 *
 */
public class NestedLookupClient {
	...
	private final static Logger log = LoggerFactory
			.getLogger(NestedLookupClient.class);
	...
	public static void main(String[] args) throws InterruptedException,
		...
		jc.setProgramName(NestedLookupClient.class.getSimpleName());
